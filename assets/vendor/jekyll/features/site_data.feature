Feature: Site data
  ...
  Scenario: Use site.time variable
    Given I have an "vistageneral.html" page that contains "{{ site.time }}"
    When I run jekyll build
    Then the _site directory should exist
    And I should see today's time in "_site/vistageneral.html"

  Scenario: Use site.posts variable for latest post
    Given I have a _posts directory
    And I have an "vistageneral.html" page that contains "{{ site.posts.first.title }}: {{ site.posts.first.url }}"
    ...
    When I run jekyll build
    Then the _site directory should exist
    And I should see "Third Post: /2009/03/27/third-post.html" in "_site/vistageneral.html"

  Scenario: Use site.posts variable in a loop
    Given I have a _posts directory
    And I have an "vistageneral.html" page that contains "{% for post in site.posts %} {{ post.title }} {% endfor %}"
    And I have the following posts:
      | title       | date       | content        |
      | First Post  | 2009-03-25 | My First Post  |
      | Second Post | 2009-03-26 | My Second Post |
    ...
    When I run jekyll build
    Then the _site directory should exist
    And I should see "Third Post  Second Post  First Post" in "_site/vistageneral.html"

  Scenario: Use site.categories.code variable
    Given I have a _posts directory
    And I have an "vistageneral.html" page that contains "{% for post in site.categories.code %} {{ post.title }} {% endfor %}"
    And I have the following posts:
    ...
    When I run jekyll build
    Then the _site directory should exist
    And I should see "Awesome Hack" in "_site/vistageneral.html"

  Scenario: Use site.tags variable
    Given I have a _posts directory
    And I have an "vistageneral.html" page that contains "{% for post in site.tags.beer %} {{ post.content }} {% endfor %}"
    And I have the following posts:
      | title          | date       | tag  | content      |
      | Delicious Beer | 2009-03-26 | beer | 1) Yuengling |
    When I run jekyll build
    Then the _site directory should exist
    And I should see "Yuengling" in "_site/vistageneral.html"

  Scenario: Order Posts by name when on the same date
  Given I have a _posts directory
  And I have an "vistageneral.html" page that contains "{% for post in site.posts %}{{ post.title }}:{{ post.previous.title}},{{ post.next.title}} {% endfor %}"
  And I have the following posts:
    | title | date       | content |
  ...
  When I run jekyll build
  Then the _site directory should exist
  And I should see "last:C, C:B,last B:A,C A:first,B first:,A" in "_site/vistageneral.html"

  Scenario: Use configuration date in site payload
    Given I have an "vistageneral.html" page that contains "{{ site.url }}"
    And I have a configuration file with "url" set to "http://example.com"
    When I run jekyll build
    Then the _site directory should exist
    And I should see "http://example.com" in "_site/vistageneral.html"

  Scenario: Access Jekyll version via jekyll.version
    Given I have an "vistageneral.html" page that contains "{{ jekyll.version }}"
    When I run jekyll build
    Then the _site directory should exist
    And I should see "\d+\.\d+\.\d+" in "_site/vistageneral.html"
