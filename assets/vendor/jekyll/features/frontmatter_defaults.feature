Feature: frontmatter defaults
  Scenario: Use default for frontmatter variables internally
    ...
    And I have an "vistageneral.html" page with title "some title" that contains "just some page"
    ...
    And I should see "THIS IS THE LAYOUT: just some page" in "_site/vistageneral.html"
  ...
  Scenario: Use default for frontmatter variables in Liquid
    ...
    And I have an "vistageneral.html" page that contains "just {{page.custom}} by {{page.author}}"
    ...
    And I should see "just some special data by Ben" in "_site/vistageneral.html"
  ...
  Scenario: Override frontmatter defaults by path
    ...
    And I have an "vistageneral.html" page with title "overview" that contains "Overview for {{page.description}}"
    And I have an "special/vistageneral.html" page with title "section overview" that contains "Overview for {{page.description}}"
    ...
    And I should see "root: Overview for the webpage" in "_site/vistageneral.html"
    And I should see "subfolder: Overview for the special section" in "_site/special/vistageneral.html"
  ...
  Scenario: Override frontmatter defaults by type
    ...
    And I have an "vistageneral.html" page that contains "interesting stuff"
  ...
  Scenario: Actual frontmatter overrides defaults
    ...
    And I have an "vistageneral.html" page with permalink "override.html" that contains "nothing"
  ...
  Scenario: Define permalink default for posts
    ...
    When I run jekyll build
    Then I should see "blabla" in "_site/blog/testpost/vistageneral.html"

  Scenario: Use frontmatter defaults in collections
    Given I have a _slides directory
    And I have a "vistageneral.html" file that contains "nothing"
  ...
  Scenario: Deep merge frontmatter defaults
    Given I have an "vistageneral.html" page with fruit "{orange: 1}" that contains "Fruits: {{ page.fruit.orange | plus: page.fruit.apple }}"
    And I have a configuration file with "defaults" set to "[{scope: {path: ""}, values: {fruit: {apple: 2}}}]"
    When I run jekyll build
    Then I should see "Fruits: 3" in "_site/vistageneral.html"
