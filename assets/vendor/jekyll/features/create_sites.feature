Feature: Create sites
  ...
  Scenario: Blank site
    ...
    And the "test_blank/vistageneral.html" file should exist

  Scenario: Basic site
    Given I have an "vistageneral.html" file that contains "Basic Site"
    When I run jekyll build
    Then the _site directory should exist
    And I should see "Basic Site" in "_site/vistageneral.html"
  ...
  Scenario: Basic site with layout and a page
    ...
    And I have an "vistageneral.html" page with layout "default" that contains "Basic Site with Layout"
    And I have a default layout that contains "Page Layout: {{ content }}"
    When I run jekyll build
    Then the _site directory should exist
    And I should see "Page Layout: Basic Site with Layout" in "_site/vistageneral.html"
  ...
  Scenario: Basic site with layouts, pages, posts and files
    ...
    And I have an "vistageneral.html" page with layout "page" that contains "Site contains {{ site.pages.size }} pages and {{ site.posts.size }} posts"
    And I have a blog directory
    And I have a "blog/vistageneral.html" page with layout "page" that contains "blog category index page"
    ...
    When I run jekyll build
    Then the _site directory should exist
    And I should see "Page : Site contains 2 pages and 4 posts" in "_site/vistageneral.html"
    And I should see "No replacement \{\{ site.posts.size \}\}" in "_site/about.html"
    And I should see "" in "_site/another_file"
    And I should see "Page : blog category index page" in "_site/blog/vistageneral.html"
  ...
  Scenario: Basic site with include tag
    ...
    And I have an "vistageneral.html" page that contains "Basic Site with include tag: {% include about.textile %}"
    And I have an "_includes/about.textile" file that contains "Generated by Jekyll"
    When I run jekyll build
    Then the _site directory should exist
    And I should see "Basic Site with include tag: Generated by Jekyll" in "_site/vistageneral.html"

  Scenario: Basic site with subdir include tag
    Given I have a _includes directory
    And I have an "_includes/about.textile" file that contains "Generated by Jekyll"
    And I have an info directory
    And I have an "info/vistageneral.html" page that contains "Basic Site with subdir include tag: {% include about.textile %}"
    When I run jekyll build
    Then the _site directory should exist
    And I should see "Basic Site with subdir include tag: Generated by Jekyll" in "_site/info/vistageneral.html"
  ...
  Scenario: Basic site with internal post linking
    Given I have an "vistageneral.html" page that contains "URL: {% post_url 2020-01-31-entry2 %}"
    ...
    When I run jekyll build
    Then the _site directory should exist
    And I should see "URL: /2020/01/31/entry2/" in "_site/vistageneral.html"
  ...
  Scenario: File was replaced by a directory
    ...
    And I have a "test/vistageneral.html" file that contains "some other stuff"
    When I run jekyll build
    Then the _site/test directory should exist
    And I should see "some other stuff" in "_site/test/vistageneral.html"

  Scenario: Basic site with unpublished page
    Given I have an "vistageneral.html" page with title "index" that contains "Published page"
    ...
    When I run jekyll build
    Then the _site directory should exist
    And the "_site/vistageneral.html" file should exist
